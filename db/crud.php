    ...
    class crud 
        {
           ...
           function __construct($conn)
            ...
            public function insertAttendees($fname, $lname, $dob, $specialty, $email, $phone, $compName, $compAddress, $compAddress2, $compCity, $compParish, $compZip)
                {
                        try 
                            {
                                //define sql statement to be executed
                                $sql = "INSERT INTO attendee (firstname, lastname, dateofbirth, specialty_id, emailaddress, contactnumber, compName, 
                                compAddress, compAddress2, compCity, compParish, compZip) VALUES (:fname, :lname, :dob, :specialty, :email, :phone, :compName, :compAddress, :compAddress2, :compCity, :compParish, :compZip)";
